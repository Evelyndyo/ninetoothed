...
# Only bit-exact unary instructions map to direct bang calls: the MLU590
# ``__bang_active_*`` transcendentals compute at reduced precision and
# saturate (measured exp(40) -> 111859.625 instead of 2.35e17), so exp/log/
# sqrt/rsqrt/tanh/sigmoid stay on the scalar ``*f`` loops inside the staged
# NRAM buffers.
_UNARY_BANG_OPS = {
    "math.abs": "__bang_abs",
}
